...
class ApiService {
  ...
  // -------------------------
  // 📱 Schedule App Startup Reminder
  // -------------------------
  Future<Map<String, dynamic>?> scheduleAppStartupReminder({String? jwtToken}) async {
    try {
      final token = (jwtToken != null && jwtToken.isNotEmpty)
          ? jwtToken
      ...
      if (response.statusCode == 200) {
        ...
        print('❌ Failed to schedule app startup reminder: ${response.statusCode}');
